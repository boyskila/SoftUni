...
public class Darts {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            int x = sc.nextInt();
            int y = sc.nextInt();
            boolean inside = isPointInRectangle(x, y, verticalRectMinX, verticalRectMaxX, verticalRectMinY,
                    verticalRectMaxY)
                    || isPointInRectangle(x, y, horizontalRectMinX, horizontalRectMaxX, horizontalRectMinY,
                            horizontalRectMaxY);
